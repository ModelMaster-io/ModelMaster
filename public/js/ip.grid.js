...
$(document).ready(function() {
    $(document).on('click', '.model-style-effect', function() {
        ...
        switch (fontStyle) {
            ...
            case 'line-through':
                style_key = 'text-decoration';
                fn_obj = formatObject.linethrough;
            break;
            default:
                style_key = '';
        }
