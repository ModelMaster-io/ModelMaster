        ...
        <div class="lcltc-in">
            <div class="lesson-contant-left-tab-contant">
                ...
                <div class="lcltc1" id="step1" style="display:block">
                    <span class="lcltc1-title">Screen 1</span>
                    <div class="lcltc1-contant">
                      ...
                      <div class="sub-lesson-step-contant" id="sub1-step2" style="display:none">
                        <strong>Step 2:</strong> The first step in building out a full financial model, is to find the information you need about the company. For the sake of this course, we're going to assume that you have the information you need to build the model. For our work we're going to start by labeling the income statement. Once you have the information, you want to lay out the structure in your spreadsheet. Let’s start with the Income Statement. In cell B2, type "FakeSoftwareCo Income Statement" so that we have a header for the first statement.
                      </div>

                      <div class="sub-lesson-step-contant" id="sub1-step3" style="display:none">
                        <strong>Step 3.</strong> Formatting is an extremely important part of financial modeling because it determines whether people can clearly understand and interpret your document. We will format the content as we go through this course. The formatting we do in this course is just one of several ways that you could format the content. Fill the background in cells B2:N2 with a dark blue fill. Then in cell B2 change the text color to white and bold the text.
                      </div>


                      <div class="sub-lesson-step-contant" id="sub1-step4" style="display:none">
                        <strong>Step 4:</strong> Next we're going to tell people what units we're using on the model. Depending on the context, "100" could be $100, $100,000, or $100,000,000. In this model we're going to show all our numbers in millions. In cell B4, type "($ in millions)" so that anyone reading our model knows what units we're using. Italicize it so that it is clear the information doesn't impact our model.
                      </div>


                      <div class="sub-lesson-step-contant" id="sub1-step5" style="display:none">
                        <strong>Step 5:</strong> Next, we will lay out the time periods that we are doing our analysis for. Financial models can be built on a monthly, quarterly, annually, or any other required time frame. In this model we're going show the information annually. Starting in cell G4, type the years from 2017 to 2024. Select cells B4:N4 and add a bottom border
                ...
                <div class="lcltc1" id="step2" style="display:none">
                    <span class="lcltc1-title">Screen 2</span>
                    <div class="lcltc1-contant">
                      ...
                      <div class="next_step_btn"><a href="javascript:void(0)" class="next-btn">NEXT</a></div>
                ...
                <div class="lcltc1" id="step3" style="display:none">
                    <span class="lcltc1-title">Screen 3</span>
                    <div class="lcltc1-contant">Lorem Ipsum is a simple dummy Text</div>
                </div>

                <div class="lcltc1" id="step4" style="display:none">
                    <span class="lcltc1-title">Screen 4</span>
