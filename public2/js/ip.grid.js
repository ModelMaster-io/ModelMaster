...
$(document).ready(function() {
    $(document).on('click', '.model-style-effect', function() {
        ...
        switch (fontStyle) {
            case 'bold':
                ...
                fn_obj = formatObject.bold;
                break;
            case 'italic':
                style_key = 'font-style';
                fn_obj = formatObject.italic;
                break;
            case 'underline':
                style_key = 'text-decoration';
                fn_obj = formatObject.underline;
                break;
            default:
                style_key = '';
        }
    ...
    $(document).on('mousedown', '.ip_grid_cell', function(event) {
        if(event.which == 3) {
